          ...
          <div className="flex flex-wrap -m-6 md:w-[85%] mx-auto">
            <div className="p-4 md:w-1/2 w-full hover:scale-105 transition-all duration-500">
              <div className="h-full bg-white text-black  p-10 rounded">
                ...
                I've had the pleasure of working with Elevate Clicks for this year, and I must say, the results have been nothing short of phenomenal. From the initial consultation to the execution of our marketing campaigns, their dedication and expertise have exceeded our expectations.
                </p>
