  ...
  <button type="submit"  class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
        ...
        <div className="container px-5 py-24 mx-auto bg-white bg-opacity-10">
          <div className="lg:pr-10 lg:py-6 mb-6 lg:mb-5 flex flex-col gap-3 text-center md:w-[80%] mx-auto">
            ...
            <p className="leading-relaxed mb-4">
              CONNECT WITH US ON SOCIAL MEDIA TO STAY UPDATED ON THE LATEST TRENDS AND INSIGHTS:  
            </p>
          </div>
      ...
      <section>
        <div className="flex flex-col gap-4 items-center mx-auto">
          ...
          <h1 className="text-lg font-bold">Reach out on our E-mail.</h1>
          <p className="text-sm">business@elevateclicks.tech</p>
